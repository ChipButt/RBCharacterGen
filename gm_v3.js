const SETTINGS=[
{name:'Farming Village',setup:'A small farming village is halfway through a frantic market day. Muddy lanes, low stone walls and animal pens surround an old stone barn beside the village square, with a broad door, hayloft and several unused storage rooms.',ending:'the whole village gathers in the square as the crisis settles',press:['A frightened herd starts moving toward the main road.','The market bell rings and the buyer is about to leave.','A storm rolls over the fields and makes every path worse.']},
{name:'Crumbling Watchtower',setup:'A lonely stone watchtower leans over the road, its upper floor open to the wind and its stairs cracked with age. The lower guardroom and locked cellar are still enclosed, dark and surprisingly intact.',ending:'the tower groans behind the party as they emerge with what they came for',press:['Loose stones begin falling from above.','A rival group can be seen approaching.','The old bell starts tolling by itself.']},
{name:'Misty Forest',setup:'The trail disappears into a wet forest where every tree looks almost identical. Mist hangs at shoulder height, and beside the path stands an abandoned forester’s lodge with shuttered windows, a stone chimney and a half-collapsed woodshed.',ending:'the mist thins and a clear path opens back toward civilisation',press:['The mist thickens enough to erase the path behind them.','Distant howls grow closer whenever they stop.','The last daylight is fading.']},
{name:'Busy Market Town',setup:'A crowded market town is packed with carts, hawkers, guards and people who are all in somebody else’s way. Overlooking the busiest street is an old guildhall with public rooms below and storerooms, offices and locked chambers above.',ending:'the market erupts into cheers and immediate exaggeration about what the party just did',press:['The town gates will close at the next bell.','A procession blocks more streets every minute.','The person they need is preparing to leave.']},
{name:'Abandoned Mine',setup:'The old mine smells of wet timber and iron. Rusted rails vanish into black tunnels, while a boarded ore-house built against the entrance still contains workrooms, storage cages and an old foreman’s office.',ending:'the party reaches daylight just as the old workings settle behind them',press:['Support beams begin cracking in sequence.','Their lantern fuel is visibly running low.','A flooded lower tunnel is rising.']},
{name:'Riverside Docks',setup:'Rain-slick docks stretch along a fast river crowded with barges, ropes and shouting workers. A tall riverside warehouse dominates the quay, with loading doors below and cramped offices and storage rooms on the upper floor.',ending:'the river carries away the last sign of trouble as the docks return to noisy normality',press:['The tide is turning and a key boat is leaving.','A crane cable starts to fray.','Harbour guards are closing the area pier by pier.']},
{name:'Snowbound Mountain Pass',setup:'A narrow mountain pass is almost buried by fresh snow. Wind cuts visibility to a few dozen feet, but an old stone waystation clings to the mountainside with a common room, stable and locked supply cellar.',ending:'the clouds break just enough to reveal the safe road down the far side',press:['Fresh snow starts sliding from the ridge.','The temperature drops sharply.','Tracks behind the group are being erased.']},
{name:'Haunted Manor',setup:'An abandoned manor stands unnaturally intact behind iron gates. Dust covers its entrance hall, side rooms and servants’ passages, but fresh footprints cross the floor and disappear deeper inside the house.',ending:'the house falls silent for the first time in years as dawn reaches the windows',press:['A grandfather clock begins counting down.','Doors behind the party start locking themselves.','The burning upstairs lamp moves from room to room.']},
{name:'Ancient Ruin',setup:'Half-buried ruins break through the earth like the bones of a forgotten city. At their centre stands the remains of a stone temple, its roof partly intact above sealed chambers, narrow corridors and a sunken inner hall.',ending:'the ruins settle and the newly revealed route points clearly toward safety',press:['The ground begins trembling.','Another explorer is closing in on the objective.','A stone doorway is slowly sealing.']},
{name:'Festival Grounds',setup:'A colourful festival has spilled across a field of tents, food stalls and temporary stages. At the edge of the grounds stands an old timber pavilion used for storage and rehearsals, with several back rooms normally closed to the public.',ending:'music and cheering swallow the last of the panic as the event finally begins',press:['The opening ceremony is minutes away.','A crowd starts moving into the wrong area.','A key organiser threatens to cancel the event.']}
];
